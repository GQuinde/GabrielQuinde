 ...
 <div style="float:left; width:60%; margin:60px auto; padding:1vw">
   <div  style="width: 100%;">     
    <div style="width: 100%; height:100%; margin: auto ; display:inline-block;" >
       <div style=" width:100%; height: 100%; top:0; font-size:20px; text-align:center; float:left;">
        	<h1>¿Quién es Quinde Montero Gabriel?</h1>
       		 <hr>
             
          <div id="posteo" style="text-align: left; font-size:0.5vw;">
                Posteado por:  Quinde Montero Gabriel?<br>
                Fecha: 2021-08-17 <br>
          </div>
        </div>
    </div>
  ...
  <div style="width: 100%; height:100%;" >
           <div  style="text-align:justify; font-size: 20px;">
                   <p class="eys-parrafo">Hola, yo soy Quinde Montero Gabriel, estudiante esmeraldeño que  desde hace 3 añosestudio en la Universidad Tecnica Luis Vargas Torres, y trabaja en diferentes areas  de Tecnología de la Información entre las cuales esta Instalacion de Software, Instalacion de Redes, Instalacion de Camaras de Seguridad  entre otras; pero en la Reparaxion de componentes es en la que mejor me desempeño. </p>
                   <p class="eys-parrafo">Desde mís estudios secundarios me he apacionado por las ciencias y la tecnología, quieza sería  por esta capacidad que tiene estas dos áres del conocimiento de solucionar muchos probemas de la sociedad; es por eso que desde que termine mis estudios de ingeniería en el bachillerato del Sagrado Corazó me he dedicado a la programación de computadoras. </p>
<p class="eys-parrafo"> El primer lenguaje con el cual empece a programar en el 2do de bachiller fue c++ y PHP <b><a href="https://en.wikipedia.org/wiki/BASIC"> basic</a></b>  para este tiempo el Sagrado Corazón contaba con laboratorios de computadora  una computadora personal de marca Dell.</p>
